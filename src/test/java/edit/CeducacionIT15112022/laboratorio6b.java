...
public class laboratorio6b {
	...
	//atributos : variables de uso general
		...
		String docPath="..\\CeducacionIT15112022\\Evidencias\\";
		WebDriver driver;
		File screen;
	...
	public void IrAContacUs() throws InvalidFormatException, IOException, InterruptedException {
		...
		String docPath2 = docPath+"docEvidencias"+LocalDate.now()+"H"+hora+"M"+min+".docx";
		
		
		//captura evidencia
		
		CapturaEvidencia.escribirTituloEnDocumento(docPath2, "Documento de evidencias de Pruebas", 24);
		CapturaEvidencia.capturarPantallaEnDocumento(driver, imagePath +"img.jpg", docPath2, "Pantalla Principal");		
		
		driver.findElement(By.linkText("Contact us")).click();
		
		//captura evidencia
		CapturaEvidencia.capturarPantallaEnDocumento(driver, imagePath +"img.jpg", docPath2, "Pantalla de contacto");		
		...
		CapturaEvidencia.capturarPantallaEnDocumento(driver, imagePath +"img.jpg", docPath2, "Form completo");
		
		driver.findElement(By.xpath("//button[@id='submitMessage']")).click();
		
		//captura evidencia
		
		CapturaEvidencia.capturarPantallaEnDocumento(driver, imagePath +"img.jpg", docPath2, "Resultado contacto");
